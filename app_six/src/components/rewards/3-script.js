...
window.addEventListener("load", function(){
  ...
  for (let i in products) {
    ...
    // Product Price
    part = document.createElement("div");
    part.innerHTML = "Points " + products[i]['price'];
...
var cart = {
  ...
  // list() : update HTML
    ...
    // Not empty
      ...
      item = document.createElement("input");
      item.type = "button";
      item.value = "Checkout - " + "Points used  " + total;
  ...
  // checkout() : checkout the cart
    ...
    alert("Needs conection to Pt points to deduct sales and conection to server for mailing list of orders");
